...
export function Hero() {
  return (
    ...
    >
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute -right-1/4 top-0 -z-10 h-[42rem] w-[42rem] rounded-full bg-[radial-gradient(circle,rgba(47,85,64,0.12),transparent_62%)] blur-2xl"
      />
      ...
      <Container className="grid items-center gap-14 lg:grid-cols-[1.05fr_0.95fr] lg:gap-16">
        ...
        <div className="max-w-2xl">
          ...
          <Reveal stagger delay={0.55} className="mt-8 flex flex-col gap-8">
            <RevealItem
              as="span"
              className="block max-w-xl text-[length:var(--text-lead)] leading-[var(--text-lead--line-height)] text-stone"
            >
        ...
        <Reveal delay={0.3} className="relative">
          <figure className="relative">
            <MaskReveal delay={0.35}>
              <div className="relative aspect-[4/5] w-full overflow-hidden rounded-lg shadow-[var(--shadow-lift)]">
                <Image
            ...
            <figcaption className="absolute -bottom-6 -left-6 hidden rounded-lg border border-line bg-cream/95 px-6 py-5 shadow-[var(--shadow-card)] backdrop-blur-sm sm:block">
              <p className="font-display text-3xl leading-none text-forest">90</p>
              <p className="mt-1 max-w-[9rem] text-xs leading-snug text-stone">
